            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        Label { text: "新建分类"; color: titleC; font.pixelSize: 26; font.bold: true }
                        Label { text: "分类会出现在任务创建页、详情页和分类列表中。"; color: subC; font.pixelSize: 13 }
                    }
                }
                ...
                Card {
                    ...
                    RowLayout {
                        ...
                        spacing: 8
                        Label { text: "创建后会立刻刷新分类列表"; color: subC; font.pixelSize: 12 }
                        Item { Layout.fillWidth: true }
                        Button { text: "重置"; implicitWidth: 88; implicitHeight: 40; onClicked: resetForm() }
                        Button { text: "新建分类"; implicitWidth: 112; implicitHeight: 40; highlighted: true; onClicked: submitCategoryForm() }
                    }
                }
            }
        }
