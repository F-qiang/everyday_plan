...
public:
    ...
    Q_INVOKABLE bool loadAllFromDatabase(const QString &dbPath, int userId, bool todayOnly = false, bool completedOnly = false, const QString &sortField = "priority", bool sortDescending = true);
